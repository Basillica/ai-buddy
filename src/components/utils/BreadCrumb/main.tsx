...
const App: Component<{
    ...
    const handleClickHome = () => {
        for (let index = 0; index < props.crumbs.length; index++) {
            if (props.crumbs[index].default) {
                props.crumbs[index].handler();
            }
        }
        navigate("/home");
    };
    ...
    return (
        <div style="align-self: stretch; height: 40px; justify-content: flex-start; align-items: center; gap: 10px; display: inline-flex; width: 100%">
            <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 10px; display: inline-flex">
                <div class={styles.user_param_innver_div}>
                    <button
                        style="width: 32px; height: 27px; padding: 8px; border-radius: 4px; justify-content: center; align-items: center; gap: 4px; display: flex; border: none"
                        ...
                        {(crumb, i) => (
                            <>
                                ...
                                {crumb.default ? (
                                    ...
                                    <button class={styles.navigation} onClick={() => crumb.handler()}>
